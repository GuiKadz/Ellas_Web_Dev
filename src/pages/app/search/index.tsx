      ...
      <Dialog defaultOpen>
        <DialogContent className="bg-zinc-950 text-white border-zinc-800">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex gap-2">
            ...
            <Input maxLength={11} {...register("search")} placeholder="Digite sua pesquisa..."/>
            <Button type="submit" disabled={isSubmitting}>
              Proucurar
            </Button>
          </form>
          {errors.search && <div className="text-red-700 w-full text-center">{errors.search.message}...</div>}
        </DialogContent>
      </Dialog>
    </div>
  )
